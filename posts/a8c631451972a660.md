...
Think about when a customer buys something—there is an order email summary that tells the customer about the order. It can be about different things: it can be about invoicing, and it can also tell the customer about new products that have been added to the catalog. This is a shared functionality across all of these services. What this pattern does is hide the complexity of having two implementations at the same time.
