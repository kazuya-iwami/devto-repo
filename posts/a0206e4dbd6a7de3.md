...
📖 **AWS re:Invent 2025 -Stripe: Revolutionizing compliance workflows w/ agentic infrastructure (IND3300)**
...
Quite frankly, I think that's what really allowed us to get the push to actually stand up this new agentic service, which was really necessary to make this happen. We went from this small notebook demo—fail fast, if you will, but it succeeded—and eventually got to this full enterprise system with their own services stood up. It was really miraculous. We also did this by having humans completely in the loop, not just during the review but also during this rigorous QA process to make sure the agent wasn't hallucinating or was providing sensible answers and could be depended on enough. We were able to finally get our initial questions out by the end of the half.
