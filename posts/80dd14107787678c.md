...
The first one is to live with business outcomes. We cannot go to a new customer with a solution and talk about technology first. It is not about Quick Suite. It is not about SageMaker. It is about what business problem we are going to solve, and then the technology might come after. Business transformation is the type of topic that we need to start discussing.
