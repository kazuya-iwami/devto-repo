...
published: true
description: 'In this video, AWS''s Dr. Swami Sivasubramanian presents a vision of "the freedom to create without limits," depicting a future where agentic AI fundamentally transforms how we work. Key announcements include TypeScript support and robotics capabilities for Strands Agents SDK, Episodic Memory functionality in Amazon Bedrock AgentCore, Reinforcement Fine-tuning, serverless model customization in SageMaker AI, Checkpointless Training in SageMaker HyperPod, and the general availability of Amazon Nova Act, which achieves 90% reliability. The session showcases real-world impact through customer stories: Blue Origin accelerated development speed by 75% and reduced mass by 40% with their Tearex system, Cox Automotive shortened work time from 2 days to 30 minutes with Fleet Mate, and Vercel demonstrated self-driving infrastructure. Byron Cook explains Neurosymbolic AI combining automated reasoning with LLMs, and a live demonstration of Amazon Connect shows human-AI collaboration in action. The AWS AI Agent Global Hackathon featured 9,500 developers from 127 countries, highlighting that we''ve entered an era where anyone can turn their ideas into reality.'
tags: ''
cover_image: 'https://raw.githubusercontent.com/kazuya-iwami/devto-repo/main/posts/images/38bb1d6543204168/120.jpg'
series: ''
canonical_url: null
id: 3084339
...
It integrates with your runbooks, code repositories, and CI/CD pipelines so that it can engage as your on-call assistant to triage issues and also prevent them by being proactive. These Frontier Agents work with higher levels of autonomy and persistence, and in doing so are able to work alongside us. Another example of these agent teammates is Amazon Quick Suite,  where AI agents work alongside business users to do research on your behalf and to find  business insights and automate routine tasks with workflows and create multi-agent workflows, all without ever  needing to write a single line of code.
